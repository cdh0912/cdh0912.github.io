...
var plumMarker = new google.maps.MarkerImage("assets/imgs/planner/dot_plum.png",
		new google.maps.Size(20, 20),
		new google.maps.Point(0, 0),
		new google.maps.Point(7, 7));
var yellowMarker = new google.maps.MarkerImage("assets/imgs/planner/dot_yellow.png",
		new google.maps.Size(20, 20),
		new google.maps.Point(0, 0),
		new google.maps.Point(7, 7));
...
function addBox(sname, sid, lat, lng) {
	...
	$("#stop").attr("id", "stop" + idNum).append("<tr><td width='70%'>"+sname+"</td><td width='30%'>"
			+ "<img onclick='markerClick(" + sid + ")' src='"+"assets/imgs/planner/stop_info.png' class='stop_infoImg'/>"
			+ "<img onclick='javascript:removeBox(this);' src='"+"assets/imgs/planner/stop_remove.png' class='stop_removeImg'/></td></tr>");
...
//		}
		...
		(function(marker, site) {
			...
			if (site.savefolder != undefined || site.saved_picture != undefined) {
				siteImageUrl = "assets/imgs/planner/upload/" + site.savefolder + "/" + site.saved_picture;
			} else {
				siteImageUrl = "assets/imgs/planner/NoImage.jpg";
			}
			...
			google.maps.event.addListener(marker, "click", function(e) {
				//인포윈도우 내용설정
					infoWindow.setContent(
						...
						"		<img src='"+"assets/imgs/planner/info_mvsite.png' id='info_mvsitebtn'></a>													" +
						"		<a href=\"javascript:addBox('" + site.site_name + "','" + site.site_id + "','" + site.latitude + "','" + site.longitude + "');\">	" + 
						"		<img src='"+"assets/imgs/planner/info_plus.png' id='info_plusbtn' onclick=''></a>												" +
						"	</div>																																	" +
						"</div>																																		"
					);
